...
var t=Ember.HTMLBars.template({id:"CMbGTc3W",block:'{"symbols":[],"statements":[[0,"Testing this website\\n\\n"],[1,[22,"outlet"],false],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"linkedin-sprinterns-2022/templates/application.hbs"}})
...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(r){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("linkedin-sprinterns-2022/app").default.create({name:"linkedin-sprinterns-2022",version:"0.0.0+8b30aaac"})
